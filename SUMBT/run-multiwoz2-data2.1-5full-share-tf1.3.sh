...
output_dir=exp-multiwoz/exp-data2.1-5full-share-tf1.3
target_slot='all'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 8 --data_dir data/multiwoz2.1_5 \
