...
class ContrastiveDataset(Dataset):
    def __init__(self, slot_dim, *features, sample_slot_num=7, sample_key_num=3, fix_dataset=False, fix_sample_num=5):
        ...
        self.fix_sample_num = fix_sample_num

        if self.fix_dataset:
            logger.info('Preparing fixed dataset...')
            self.tensors = []
            for i in range(self.fix_sample_num):
                for j in tqdm(range(self.dialog_num)):
                    self.tensors.append(self.sample(j))
...
def main():
    ...
    # sample_slot_num = 7, sample_key_num = 3, fix_dataset = False, fix_sample_num = 5
    parser.add_argument('--sample_slot_num', default=7, type=int)
    parser.add_argument('--sample_key_num', default=3, type=int)
    parser.add_argument('--fix_sample_num', default=5, type=int)
