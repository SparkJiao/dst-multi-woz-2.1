            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    if args.local_rank in [-1, 0] and global_step % args.per_eval_steps == 0:
                        ...
                        torch.save(optimizer1.state_dict(), os.path.join(output_dir, "optimizer1.pt"))
                        torch.save(scheduler1.state_dict(), os.path.join(output_dir, "scheduler1.pt"))
                        torch.save(optimizer2.state_dict(), os.path.join(output_dir, "optimizer1.pt"))
                        torch.save(scheduler2.state_dict(), os.path.join(output_dir, "scheduler1.pt"))
