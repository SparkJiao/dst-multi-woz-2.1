...
output_dir=exp-multiwoz/exp-data2.1-5full-share-bert-cls1.0
target_slot='all'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-cls.py --do_train --do_eval --num_train_epochs 30 --data_dir data/multiwoz2.1_5 \
--bert_model bert-base-uncased --do_lower_case --bert_dir $bert_dir --task_name bert-gru-sumbt \
--nbt bert --output_dir $output_dir --target_slot all --warmup_proportion 0.1 --learning_rate 1e-4 \
