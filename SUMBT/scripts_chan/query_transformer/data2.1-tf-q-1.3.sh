...
output_dir=exp-multiwoz/data2.1-tf-q/v1.3  # loss is averaged over dialogue size
target_slot='all'
nbt='query'
...
python code_chan/main_update_fine.py --do_train --do_eval --num_train_epochs 50 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 3 --eval_batch_size 3 --distance_metric euclidean --patience 20 \
...
--max_loss_scale 64 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 2000