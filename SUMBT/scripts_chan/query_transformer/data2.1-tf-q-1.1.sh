...
output_dir=exp-multiwoz/data2.1-tf-q/v1.1  # loss is averaged over dialogue size
target_slot='all'
nbt='query'
...
python code_chan/main_update.py --do_train --do_eval --num_train_epochs 200 --data_dir data/multiwoz2.1_5 \
