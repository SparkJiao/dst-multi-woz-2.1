...
output_dir=exp-multiwoz/data2.1-tf-q/v1.5-3gpu  # loss is averaged over dialogue size
target_slot='all'
nbt='query'
...
--train_batch_size 6 --eval_batch_size 6 --distance_metric euclidean --patience 20 \
