...
output_dir=exp-multiwoz/data2.1-tf-q/v1.0
target_slot='all'
nbt='query'
...
python code_chan/main_update.py --do_train --do_eval --num_train_epochs 100 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 8 --eval_batch_size 8 --distance_metric euclidean --patience 20 \
...
--max_loss_scale 256 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500