...
output_dir=exp-multiwoz/data2.0-share-sa1.6.1  # num_train_epochs 6 -> 5
target_slot='all'
nbt='sa'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.0 \
