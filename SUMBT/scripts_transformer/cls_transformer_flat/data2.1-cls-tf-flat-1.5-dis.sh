...
output_dir='/home/share/jiaofangkai/SUMBT/exp-multiwoz/data2.1-cls-tf-flat/v1.5-dis'
...
#code_transformer/main_torch_1_6_distribute.py --do_train --do_eval --num_train_epochs 50 --data_dir data/multiwoz2.1_5 \
...
#--train_batch_size 8 --eval_batch_size 1 --distance_metric euclidean --patience 10 \
#--tf_dir tensorboard --max_seq_length 64 --max_turn_length 22 \
#--gradient_accumulation_steps 8 --attn_head 4 --add_query_attn \
...
#--cls_type 0 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500 --cls_loss_weight 0.3

python \
code_transformer/main_torch_1_6_distribute.py --do_eval --num_train_epochs 50 --data_dir data/multiwoz2.1_5 \
--bert_model bert-base-uncased --do_lower_case --bert_dir $bert_dir --task_name bert-gru-sumbt --bert_name ${bert_name} \
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.1 --learning_rate 1e-4 \
--train_batch_size 8 --eval_batch_size 1 --distance_metric euclidean --patience 10 \
--tf_dir tensorboard --max_seq_length 64 --max_turn_length 22 \
