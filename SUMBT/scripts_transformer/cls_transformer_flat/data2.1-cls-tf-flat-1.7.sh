...
output_dir=exp-multiwoz/data2.1-cls-tf-flat/v1.7
target_slot='all'
nbt='flat'
...
--cls_type 0 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500 --cls_loss_weight 0.3 --efficient