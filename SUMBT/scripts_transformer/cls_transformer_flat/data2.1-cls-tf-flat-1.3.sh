...
output_dir_pt=exp-multiwoz/data2.1-cls-tf-flat/v1.3-pt
output_dir=exp-multiwoz/data2.1-cls-tf-flat/v1.3
target_slot='all'
nbt='flat'
...
--nbt $nbt --output_dir $output_dir_pt --target_slot $target_slot --warmup_proportion 0.1 --learning_rate 5e-4 \
--train_batch_size 32 --eval_batch_size 2 --distance_metric euclidean --patience 10 \
...
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 0 --max_loss_scale 256 --value_embedding_type mean --intermediate_size 1536 --per_eval_steps 500 \
--pretrain $output_dir_pt/pytorch_model.bind