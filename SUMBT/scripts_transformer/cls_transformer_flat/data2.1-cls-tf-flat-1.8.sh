...
output_dir=exp-multiwoz/data2.1-cls-tf-flat/v1.8
target_slot='all'
nbt='flat'
...
--train_batch_size 32 --eval_batch_size 1 --distance_metric euclidean --patience 15 \
...
--cls_type 0 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500 --efficient