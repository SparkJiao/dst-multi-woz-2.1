...
#output_dir='/home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-flat-copy/v1.1/'
output_dir='/home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-flat-copy/v1.1/checkpoint-16500/'
target_slot='all'
nbt='copy'
...
#code_transformer/main_torch_1_6_distribute.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
...
#--cls_type 0 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500 --add_interaction --efficient --sinusoidal_embeddings \
#--pretrain /home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-pretrain/v1.0/checkpoint-1500/pytorch_model.bin
