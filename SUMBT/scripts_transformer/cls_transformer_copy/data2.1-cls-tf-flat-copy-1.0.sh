...
output_dir='/home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-flat-copy/v1.0'
...
#--test_file data/multiwoz2.1_5/test-5-full-value.tsv \
#--ontology data/multiwoz2.1_5/ontology-full.json \
#--cls_type 0 --value_embedding_type cls --intermediate_size 768 --per_eval_steps 500 --add_interaction
