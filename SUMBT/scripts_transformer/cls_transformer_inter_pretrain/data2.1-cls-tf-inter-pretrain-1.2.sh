...
output_dir='/home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-pretrain/v1.2'
...
python \
code_transformer/self_sup_pretrain_torch_1_6.py --do_train --do_eval --num_train_epochs 10 --data_dir data/multiwoz2.1_5 \
