...
output_dir='/home/jiaofangkai/share/SUMBT/exp-multiwoz/data2.1-cls-tf-pretrain/v1.0'
...
code_transformer/self_sup_pretrain_torch_1_6_distribute.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
...
--cls_type 0 --value_embedding_type cls --intermediate_size 1536 --per_eval_steps 500 --add_interaction --efficient  \
--sinusoidal_embeddings

#CUDA_VISIBLE_DEVICES=1 python \
#code_transformer/self_sup_pretrain_torch_1_6_distribute.py --do_train --do_eval --num_train_epochs 30 --data_dir data/multiwoz2.1_5 \
#--bert_model bert-base-uncased --do_lower_case --bert_dir $bert_dir --task_name bert-gru-sumbt --bert_name ${bert_name} \
