...
output_dir=exp-multiwoz/data2.1-cls-graph2p-distil/v1.0
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/distilbert-base-uncased'
bert_name='distilbert-base-uncased'

python code_transformer/main.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 4 --eval_batch_size 1 --distance_metric product --patience 5 \
