...
output_dir='share/exp-multiwoz/data2.1-cls-tf-bi-mask/v4.9'
target_slot='all'
nbt='bi_graph_fix'
...
--test_file data/multiwoz2.1_5/test-5-full-value.tsv \
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 1 --value_embedding_type cls --per_eval_steps 200 --pos_emb_per_layer --cls_n_head 12 --cls_d_head 64
