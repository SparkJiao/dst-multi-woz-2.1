...
output_dir='share/exp-multiwoz/data2.1-cls-tf-bi-mask/v2.4'
target_slot='all'
nbt='bi_graph'
...
# Version 2.4: warmup-proportion 0.06 -> 0.1 / epoch 40 -> 50 / lr 1e-4 -> 2e-4
#     lr 2e-4 leads to NAN. change to 1e-4 and epoch 50 -> 100

#python -m torch.distributed.launch --nproc_per_node 2 \
#code_transformer/main_torch_1_6_distribute.py --do_train --do_eval --num_train_epochs 100 --data_dir data/multiwoz2.1_5 \
...
#--train_batch_size 8 --eval_batch_size 1 --distance_metric product --patience 15 \
...
python \
code_transformer/main_torch_1_6.py --do_train --do_eval --num_train_epochs 100 --data_dir data/multiwoz2.1_5 \
--bert_model bert-base-uncased --do_lower_case --bert_dir $bert_dir --task_name bert-gru-sumbt --bert_name ${bert_name} \
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.1 --learning_rate 1e-4 \
