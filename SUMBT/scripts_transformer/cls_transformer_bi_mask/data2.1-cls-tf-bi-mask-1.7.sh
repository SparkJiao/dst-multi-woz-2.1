...
output_dir='share/exp-multiwoz/data2.1-cls-tf-bi-mask/v1.7.1'
target_slot='all'
nbt='bi_graph'
...
# Version 1.7: batch size 16 -> 8 / add dropout
# Version 1.7.1: lower learning rate lr 1e-4 -> 5e-5 batch size 16 -> 32
