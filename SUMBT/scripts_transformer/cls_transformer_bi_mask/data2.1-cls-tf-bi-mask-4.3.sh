...
output_dir='share/exp-multiwoz/data2.1-cls-tf-bi-mask/v4.3'
target_slot='all'
nbt='bi_graph_fix'
...
# graph_add_layers 9,10,11 -> 6,7,8,9,10,11
...
--test_file data/multiwoz2.1_5/test-5-full-value.tsv \
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 1 --value_embedding_type cls --per_eval_steps 250 --pos_emb_per_layer --graph_add_layers 6,7,8,9,10,11
