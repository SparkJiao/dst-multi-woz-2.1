...
output_dir='share/exp-multiwoz/data2.1-cls-tf-bi-mask/v3.1'
target_slot='all'
nbt='bi_graph'
...
# Version 2.2: lr 1e-4 -> 5e-5
# Version 2.3: lr 5e-5 -> 1e-4 / batch_size 16 -> 8
# Version 3.0: Remove dropout in graph
# Version 3.1: Remove layer norm in graph
...
--test_file data/multiwoz2.1_5/test-5-full-value.tsv \
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 1 --value_embedding_type cls --per_eval_steps 250 --graph_no_dropout --graph_no_layer_norm
