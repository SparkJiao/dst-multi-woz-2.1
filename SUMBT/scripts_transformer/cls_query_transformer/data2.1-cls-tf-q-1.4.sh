...
output_dir=exp-multiwoz/data2.1-cls-tf-q/v1.4
target_slot='all'
nbt='query'
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.1 --learning_rate 1e-5 \
--train_batch_size 8 --eval_batch_size 8 --distance_metric product --patience 20 \
