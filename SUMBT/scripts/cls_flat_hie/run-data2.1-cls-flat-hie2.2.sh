...
#output_dir=exp-multiwoz/data2.1-cls-hie/v2.1-f  # Fix bug.
output_dir=exp-multiwoz/data2.1-cls-hie/v2.2  #
target_slot='all'
nbt='hie_fuse'
...
--train_batch_size 16 --eval_batch_size 2 --distance_metric product --patience 5 \
