...
#output_dir=exp-multiwoz/data2.1-cls-hie/v2.2  # --hie_add_layer_norm --hie_residual
output_dir=exp-multiwoz/data2.1-cls-hie/v2.3  # --hie_wd_add_layer_norm --hie_wd_residual --hie_wd_add_output
target_slot='all'
nbt='hie_fuse'
...
--cls_type 1 --hie_add_sup 0.8 --max_grad_norm 1.0 --hie_add_layer_norm --hie_residual \
--hie_wd_add_layer_norm --hie_wd_residual --hie_wd_add_output
