...
#output_dir=exp-multiwoz/data2.1-cls-hie/v2.1-weight  #  --cls_loss_weight 10.
#output_dir=exp-multiwoz/data2.1-cls-hie/v2.1-weight1.1  #  --cls_loss_weight 5.
output_dir=exp-multiwoz/data2.1-cls-hie/v2.1-weight1.2  #  --cls_loss_weight 4. --hie_add_sup 12.0
target_slot='all'
nbt='hie_fuse'
...
--cls_type 1 --hie_add_sup 12.0 --max_grad_norm 1.0 --cls_loss_weight 4.0
