...
#output_dir=exp-multiwoz/data2.1-cls-hie/v3.1
output_dir=exp-multiwoz/data2.1-cls-hie/v3.2  # gate_type 0 -> 1
target_slot='all'
nbt='hie_fuse'
...
--cls_type 1 --hie_add_sup 1.0 --max_grad_norm 1.0 --gate_type 1
