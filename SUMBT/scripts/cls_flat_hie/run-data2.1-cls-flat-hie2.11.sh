...
#output_dir=exp-multiwoz/data2.1-cls-hie/v2.10  # --hidden_output
output_dir=exp-multiwoz/data2.1-cls-hie/v2.11  # --cls_type 0
target_slot='all'
nbt='hie_fuse'
...
--cls_type 0 --hie_add_sup 0.8 --max_grad_norm 1.0 --hidden_output
