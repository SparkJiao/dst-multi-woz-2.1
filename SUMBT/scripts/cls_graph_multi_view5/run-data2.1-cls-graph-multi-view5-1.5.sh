...
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view5/1.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view5/1.1  # lr 5e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view5/1.5  # --graph_value_sup 1.0 -> 1.2
target_slot='all'
nbt='graph_multi_view5'
...
--cls_type 0 --extra_nbt --graph_value_sup 1.2 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --multi_view_diag_attn_hidden_scale 2.0