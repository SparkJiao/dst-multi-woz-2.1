...
output_dir=exp-multiwoz/data2.1-turn-baseline/v1.3  # lr 5e-5 -> 4e-5
target_slot='all'
nbt='turn-baseline'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-turn.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.1_5 \
