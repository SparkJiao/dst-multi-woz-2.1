...
output_dir=exp-multiwoz/data2.1-cls-graph2p-latent-baseline/v1.1  # graph_value_sup 1.0 -> 0.0
target_slot='all'
...
--cls_type 0 --extra_nbt --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
