...
output_dir=exp-multiwoz/data2.1-domain-baseline/v1.2
target_slot='all'
nbt='domain-baseline'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-cls-domain.py --do_eval --num_train_epochs 6 --data_dir data/multiwoz2.1_5 \
