...
output_dir=exp-multiwoz/data2.1-cls-stack/v2.0
target_slot='all'
nbt='stack'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-cls-clean.py --do_train --do_eval --num_train_epochs 8 --data_dir data/multiwoz2.1_5 \
