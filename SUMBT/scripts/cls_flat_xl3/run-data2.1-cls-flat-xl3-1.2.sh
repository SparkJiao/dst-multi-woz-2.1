...
#output_dir=exp-multiwoz/data2.1-cls-flat-xl3/v1.0
#output_dir=exp-multiwoz/data2.1-cls-flat-xl3/v1.1  # epoch 6 -> 5 lr 5e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-flat-xl3/v1.2  # cls_type 1->0
target_slot='all'
nbt='flat_xl3'
