...
output_dir=exp-multiwoz/data2.1-cls-graph2p-baseline/v1.1-train-partial
target_slot='train'
...
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 0 --extra_nbt --attn_head 12 --extra_nbt_attn_head 12 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --train_single train --domain_list ${domain_list}