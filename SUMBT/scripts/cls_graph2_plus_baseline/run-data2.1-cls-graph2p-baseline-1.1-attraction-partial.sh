...
output_dir=exp-multiwoz/data2.1-cls-graph2p-baseline/v1.1-attraction-partial
target_slot='attraction'
nbt='graph2_p_baseline'
...
--cls_type 0 --extra_nbt --attn_head 12 --extra_nbt_attn_head 12 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --domain_list ${domain_list}
...
--ontology data/multiwoz2.1_5/ontology-full.json \
--cls_type 0 --extra_nbt --attn_head 12 --extra_nbt_attn_head 12 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --train_single attraction --domain_list ${domain_list}