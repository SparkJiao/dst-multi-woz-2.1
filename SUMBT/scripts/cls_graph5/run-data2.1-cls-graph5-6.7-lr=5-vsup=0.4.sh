...
output_dir=exp-multiwoz/data2.1-cls-graph5/v6.7-lr=5-vsup=0.4  # --graph_add_output
target_slot='all'
nbt='graph5'
...
--cls_type 0 --fuse_type 3 --extra_nbt --extra_nbt_attn_head 12 --graph_value_sup 0.4 --attn_head 12 --diag_attn_hidden_scale 1.0 \
