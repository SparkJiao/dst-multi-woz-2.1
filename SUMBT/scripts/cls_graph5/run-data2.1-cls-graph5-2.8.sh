...
#output_dir=exp-multiwoz/data2.1-cls-graph5/v2.7  # value_sup 1.0 -> 0.8
output_dir=exp-multiwoz/data2.1-cls-graph5/v2.8  # value_sup 0.8 -> 0.9
target_slot='all'
nbt='graph5'
...
--cls_type 0 --fuse_type 3 --extra_nbt --graph_value_sup 0.9 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
