...
output_dir=exp-multiwoz/data2.1-cls-graph5/v6.7-lr=3  # --graph_add_output
target_slot='all'
nbt='graph5'
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.2 --learning_rate 3e-5 \
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --mask_self --graph_attn_type 1 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output