...
output_dir=exp-multiwoz/data2.1-cls-graph5/v4.0  # batch_size 1 -> 4 epoch 5 -> 20
target_slot='all'
nbt='graph5'
...
--train_batch_size 4 --eval_batch_size 1 --distance_metric product --patience 20 \
--tf_dir tensorboard --max_seq_length 108 --max_turn_length 22 \
--fp16 --fp16_opt_level O1 --gradient_accumulation_steps 2 \
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --mask_self