...
output_dir=exp-multiwoz/data2.1-cls-graph5/v6.1-wm=0.2-head=12  # warmup_proportion 0.1 -> 0.2  graph_attn_head 6 -> 12
target_slot='all'
nbt='graph5'
bert_dir='/home/jiaofangkai/'

# test: 52.373 dev: 56.048
...
--cls_type 0 --fuse_type 3 --graph_value_sup 1.0 --attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --mask_self --graph_attn_type 1 --graph_attn_head 12