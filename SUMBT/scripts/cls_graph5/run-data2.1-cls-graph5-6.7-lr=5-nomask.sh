...
output_dir=exp-multiwoz/data2.1-cls-graph5/v6.7-lr=5-nomask-test  # --graph_add_output remove --mask_self
target_slot='all'
nbt='graph5'
bert_dir='/home/jiaofangkai/'

# dev: 56.387 test: 52.577%
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --graph_attn_type 1 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output