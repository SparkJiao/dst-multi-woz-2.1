...
output_dir=exp-multiwoz/data2.1-cls-graph5/v6.3  # lr 4e-5 -> 5e-5 graph attn head 6 -> 12
target_slot='all'
nbt='graph5'
bert_dir='/home/jiaofangkai/'

# dev: 56.9162  test: 52.672
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --mask_self --graph_attn_type 1 --graph_attn_head 6