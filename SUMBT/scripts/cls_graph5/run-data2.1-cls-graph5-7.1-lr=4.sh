...
#output_dir=exp-multiwoz/data2.1-cls-graph5/v7.0  # version 7 takes simple mlp as self attention fusion block
output_dir=exp-multiwoz/data2.1-cls-graph5/v7.1-lr=4  # --fuse_add_layer_norm
target_slot='all'
nbt='graph5'
bert_dir='/home/jiaofangkai/'

# dev: 56.33 test: 52.496  # pretrained-bert==0.6.1 有问题需要重新跑
...
--mask_self --graph_attn_type 1 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output \
--sa_fuse_type simple --fuse_add_layer_norm