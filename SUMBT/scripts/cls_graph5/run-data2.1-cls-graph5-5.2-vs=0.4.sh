...
output_dir=exp-multiwoz/data2.1-cls-graph5/v5.2-vs=0.4  # value_sup 1.0 -> 0.4
target_slot='all'
nbt='graph5'
...
--cls_type 0 --fuse_type 3 --graph_value_sup 0.4 --attn_head 12 --diag_attn_hidden_scale 1.0 \
