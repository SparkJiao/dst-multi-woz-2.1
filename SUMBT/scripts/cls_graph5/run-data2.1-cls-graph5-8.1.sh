...
#output_dir=exp-multiwoz/data2.1-cls-graph5/v6.6  # lr 5e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-graph5/v6.7-lr=5  # --graph_add_output
#output_dir=exp-multiwoz/data2.1-cls-graph5/v8.0  # version 8.0 use transformer as belief tracker --sa_add_residual
output_dir=exp-multiwoz/data2.1-cls-graph5/v8.1  # --lr 5e-5 -> 4e-5
target_slot='all'
nbt='graph5'
bert_dir='/home/jiaofangkai/'

# dev: 55.8177 test: 52.496%
...
--cls_type 0 --fuse_type 3 --extra_nbt --extra_nbt_attn_head 12 --graph_value_sup 1.0 --attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --sa_add_residual --mask_self \
--graph_attn_type 1 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output --sa_fuse_type transformer