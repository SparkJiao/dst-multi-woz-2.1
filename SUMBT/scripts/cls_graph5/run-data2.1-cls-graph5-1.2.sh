...
output_dir=exp-multiwoz/data2.1-cls-graph5/v1.2  # epoch 5 -> 8
target_slot='all'
nbt='graph5'
...
--cls_type 0 --fuse_type 3 --extra_nbt --graph_value_sup 1.0 --attn_head 6 --extra_nbt_attn_head 6 --diag_attn_hidden_scale 1.0 \
