...
#output_dir=exp-multiwoz/data2.1-cls-flat-xl2/v1.0
output_dir=exp-multiwoz/data2.1-cls-flat-xl2/v5.0  # BiLinear similarity; --sa_no_position_embedding
target_slot='all'
nbt='flat_xl2'
...
--cls_type 1 --sa_no_position_embedding
