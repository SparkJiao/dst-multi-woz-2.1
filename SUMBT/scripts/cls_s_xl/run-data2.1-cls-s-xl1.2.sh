...
#output_dir=exp-multiwoz/data2.1-cls-s-xl/v1.0
#output_dir=exp-multiwoz/data2.1-cls-s-xl/v1.1
output_dir=exp-multiwoz/data2.1-cls-s-xl/v1.2
target_slot='all'
nbt='s_xl'
...
--cls_type 1 --pre_turn 3 --use_context
