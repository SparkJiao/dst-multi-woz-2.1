...
output_dir=exp-multiwoz/zero-shot/data2.0/5-domain-v1.0
target_slot='all'
nbt='sa'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 6 --data_dir data/multiwoz2.0 \
