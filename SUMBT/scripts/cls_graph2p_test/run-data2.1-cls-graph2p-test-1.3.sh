...
#output_dir=exp-multiwoz/data2.1-cls-graph2p-test/v1.1  # remove --add_relu
output_dir=exp-multiwoz/data2.1-cls-graph2p-test/v1.3  # --add_weight
target_slot='all'
nbt='graph2_p_test'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --add_weight