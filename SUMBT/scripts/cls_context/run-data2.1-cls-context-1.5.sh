...
output_dir=exp-multiwoz/data2.1-cls-context/v1.5  # --context_agg --context_agg_fusion
target_slot='all'
nbt='context'
...
--mask_self --extra_nbt --fuse_type 1 --cls_type 0 --context_agg --context_agg_fusion