...
#output_dir=exp-multiwoz/data2.1-cls-context/v1.0
#output_dir=exp-multiwoz/data2.1-cls-context/v1.1  # fuse type 0 -> 1  cls_type 1 -> 0
#output_dir=exp-multiwoz/data2.1-cls-context/v1.2  # fuse type 0 -> 2
#output_dir=exp-multiwoz/data2.1-cls-context/v2.0  # --diag_attn_hidden_scale 2.0 -> 1.0
output_dir=exp-multiwoz/data2.1-cls-context/v2.1  # --diag_attn_hidden_scale 1.0 -> 0.5
target_slot='all'
nbt='context'
...
--mask_self --extra_nbt --fuse_type 2 --cls_type 0 --diag_attn_hidden_scale 0.5