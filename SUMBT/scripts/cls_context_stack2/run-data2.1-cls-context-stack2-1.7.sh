...
#output_dir=exp-multiwoz/data2.1-cls-context-stack2/v1.6  # --max_seq_len 64 -> 128 epoch 4 -> 5 lr 4e-5 -> 3.5e-5
output_dir=exp-multiwoz/data2.1-cls-context-stack2/v1.7  # epoch 5 -> 4 lr 4e-5 -> 3.5e-5
target_slot='all'
...
--tf_dir tensorboard --max_seq_length 128 --max_turn_length 22 \
