...
#output_dir=exp-multiwoz/data2.1-cls-context-verify/v1.0
#output_dir=exp-multiwoz/data2.1-cls-context-verify/v1.2  #  --diag_attn_hidden_scale 2.0 -> 1.0
output_dir=exp-multiwoz/data2.1-cls-context-verify/v1.3  #  max_seq_length 64 -> 90
target_slot='all'
nbt='context_verify'
...
--extra_nbt --cls_type 1 --diag_attn_hidden_scale 1.0