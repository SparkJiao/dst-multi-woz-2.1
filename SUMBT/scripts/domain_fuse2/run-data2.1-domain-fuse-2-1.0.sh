...
output_dir=exp-multiwoz/data2.1-domain-fuse-2/v1.0
target_slot='all'
nbt='domain-fuse-2'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-cls-domain.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
