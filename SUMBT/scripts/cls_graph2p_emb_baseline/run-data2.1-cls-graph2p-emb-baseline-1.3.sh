...
#output_dir=exp-multiwoz/data2.1-cls-graph2p-emb-baseline/v1.0
#output_dir=exp-multiwoz/data2.1-cls-graph2p-emb-baseline/v1.1  # lr 4e-5 -> 5e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p-emb-baseline/v1.2  # --diag_attn_hidden_scale 2.0 -> 1.0 --graph_value_sup 1.0
output_dir=exp-multiwoz/data2.1-cls-graph2p-emb-baseline/v1.3  # 5e-5 -> 4e-5
target_slot='all'
nbt='graph2_p_emb_baseline'
