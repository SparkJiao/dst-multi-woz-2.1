...
#output_dir=exp-multiwoz/data2.1-cls-sa-flat/v3.0
#output_dir=exp-multiwoz/data2.1-cls-sa-flat/v3.2  # lr 5e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-sa-flat/v3.3  # remove --override_attn
output_dir=exp-multiwoz/data2.1-cls-sa-flat/v3.4  # epoch 6 -> 5
target_slot='all'
nbt='flat_test1_f'
...
--cls_type 1 --max_loss_scale 256 --value_embedding_type mean
