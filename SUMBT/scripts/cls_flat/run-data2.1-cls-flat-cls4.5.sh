...
output_dir=exp-multiwoz/data2.1-cls-sa-flat/v4.5  # warmup proportion 0.1 -> 0.05
target_slot='all'
nbt='flat_test1_ff'
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.05 --learning_rate 4e-5 \
