...
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view3/v1.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view3/v1.1  # lr 4e-5 -> 3e-5
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view3/v1.4  # remove sa_add_layer_norm
target_slot='all'
nbt='graph_multi_view3'
