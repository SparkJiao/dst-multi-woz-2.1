...
output_dir=exp-multiwoz/data2.1-share-sa-flat/v1.4  # max_seq_length -> 64
target_slot='all'
nbt='flat_test1'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_eval --num_train_epochs 6 --data_dir data/multiwoz2.1_5 \
