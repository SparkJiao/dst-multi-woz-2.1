...
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.17  # attn_head 6 -> 12
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.18  # --sa_add_layer_norm
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --attn_head 12 --sa_add_layer_norm