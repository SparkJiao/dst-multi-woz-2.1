...
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.7  # lr 4e-5 -> 3e-5
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.8  # cls_type 1 -> 0
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.5