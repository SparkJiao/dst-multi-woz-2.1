...
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.16  # max_seq_length 64 -> 80
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.26  # lr 4e-5 -> 3e-5
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.26.1  # epoch 5 -> 8
target_slot='all'
nbt='graph2'
