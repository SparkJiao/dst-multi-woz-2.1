...
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.21-seed23  # --sa_add_residual
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --sa_add_layer_norm --sa_add_residual --seed 23