...
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.22  # --value_attn_head 1 -> 6 --value_attn_output
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.23  # --graph_attn_head 6 -> 1
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --value_attn_output