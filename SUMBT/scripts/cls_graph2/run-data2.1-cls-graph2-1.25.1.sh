...
#output_dir=exp-multiwoz/data2.1-cls-graph2/v1.25  # --dropout 0.4
output_dir=exp-multiwoz/data2.1-cls-graph2/v1.25.1  # epoch 5 -> 8
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --dropout 0.4