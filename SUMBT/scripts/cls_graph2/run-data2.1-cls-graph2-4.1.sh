...
# version 4.0 use a hard attention in graph connecting
#output_dir=exp-multiwoz/data2.1-cls-graph2/v4.0
output_dir=exp-multiwoz/data2.1-cls-graph2/v4.1  # --graph_add_sup 0.2
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --graph_hard_attn --graph_add_sup 0.2