...
output_dir=exp-multiwoz/data2.1-cls-graph2/v5.5  # sa_add_residual sa_add_layer_norm
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --sa_add_residual --sa_add_layer_norm