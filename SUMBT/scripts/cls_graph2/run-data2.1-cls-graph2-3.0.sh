...
output_dir=exp-multiwoz/data2.1-cls-graph2/v3.0  # --graph_add_sup 0.4 version 3.0 add graph supervision
target_slot='all'
nbt='graph2'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.8 --graph_add_sup 0.4