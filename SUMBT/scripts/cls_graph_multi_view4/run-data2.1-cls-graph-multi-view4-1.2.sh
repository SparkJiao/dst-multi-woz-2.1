...
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view4/1.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view4/1.1  # lr 5e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view4/1.2  # lr 4e-5 -> 3e-5
target_slot='all'
nbt='graph_multi_view4'
