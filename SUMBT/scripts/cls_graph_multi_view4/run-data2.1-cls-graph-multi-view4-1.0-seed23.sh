...
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view4/1.0-seed23
target_slot='all'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --multi_view_diag_attn_hidden_scale 2.0 --seed 23