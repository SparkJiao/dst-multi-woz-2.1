...
#output_dir=exp-multiwoz/data2.1-cls-graph2p-multi-hop/v2.0  # --hop_update_self
output_dir=exp-multiwoz/data2.1-cls-graph2p-multi-hop/v2.2  # --graph_value_sup 1.0 -> 0.9
target_slot='all'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --num_layers 1 --hop_update_self