...
output_dir=exp-multiwoz/data2.1-cls-graph6/v2.0  # version 8.0 use transformer as belief tracker --sa_add_residual
target_slot='all'
nbt='graph6'
...
--graph_attn_type 1 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output --sa_fuse_type gate