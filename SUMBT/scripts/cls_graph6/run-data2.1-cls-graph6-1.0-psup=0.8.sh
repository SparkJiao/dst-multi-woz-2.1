...
output_dir=exp-multiwoz/data2.1-cls-graph6/v1.0-psup=0.8
target_slot='all'
nbt='graph6'
...
--graph_attn_type 0 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output --sa_fuse_type gate --pre_cls_sup 0.8