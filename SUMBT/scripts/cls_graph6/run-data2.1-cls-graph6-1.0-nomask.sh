...
output_dir=exp-multiwoz/data2.1-cls-graph6/v1.0-nomask # remove --mask_self
target_slot='all'
nbt='graph6'
...
--cls_type 0 --fuse_type 4 --extra_nbt --extra_nbt_attn_head 12 --graph_value_sup 1.0 --attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 64 --value_embedding_type mean --sa_add_layer_norm --sa_add_residual \
--graph_attn_type 0 --graph_attn_head 12 --graph_add_layer_norm --graph_add_output --sa_fuse_type gate