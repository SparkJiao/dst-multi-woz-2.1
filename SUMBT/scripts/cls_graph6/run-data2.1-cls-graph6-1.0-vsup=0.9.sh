...
output_dir=exp-multiwoz/data2.1-cls-graph6/v1.0-vsup=0.9  # version 8.0 use transformer as belief tracker --sa_add_residual
target_slot='all'
nbt='graph6'
...
--cls_type 0 --fuse_type 4 --extra_nbt --extra_nbt_attn_head 12 --graph_value_sup 0.9 --attn_head 12 --diag_attn_hidden_scale 1.0 \
