...
output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.3  # epoch 5 -> 6
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls-transfer.py --do_train --do_eval --num_train_epochs 6 --data_dir data/multiwoz2.1_5 \
