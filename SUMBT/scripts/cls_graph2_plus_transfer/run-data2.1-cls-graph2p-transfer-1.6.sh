...
output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.6  # bs 1 -> 4 epoch 5 -> 20
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls-transfer.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
...
--fp16 --fp16_opt_level O2 --gradient_accumulation_steps 2 \
...
--max_loss_scale 256 --value_embedding_type mean --transfer_sup 0.8