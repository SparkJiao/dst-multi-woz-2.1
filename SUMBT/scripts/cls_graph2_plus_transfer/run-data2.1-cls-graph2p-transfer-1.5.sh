...
#output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.0
#output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.1  # lr 3e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.2  # 4e-5 -> 5e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.4  # transfer_sup 0.8 -> 1.5
output_dir=exp-multiwoz/data2.1-cls-graph2p-transfer/v1.5  # transfer_sup 1.5 -> 2.0
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls-transfer.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.1_5 \
...
--max_loss_scale 256 --value_embedding_type mean --transfer_sup 2.0