...
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.2  # epoch 5 -> 6 lr 4e-5 -> 5e-5
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v2.0  # remove --query_add_residual --query_add_layer_norm
output_dir=exp-multiwoz/data2.1-cls-context-stack/v2.1  # remove --context_add_residual --context_add_layer_norm
target_slot='all'
nbt='context_stacked'
...
--mask_self --extra_nbt --fuse_type 1 --cls_type 0 \
--ff_add_residual --ff_add_layer_norm
