...
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.0
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.3  # remove `--mask_self`
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.4  # lr 4e-5 -> 3.5e-5
#output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.6  # --override_attn  The bug has been fixed.
output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.9  # --attn_head 12 --ff_hidden_size 2048
target_slot='all'
nbt='context_stacked'
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.1 --learning_rate 3.5e-5 \
...
--override_attn --attn_head 12 --ff_hidden_size 2048