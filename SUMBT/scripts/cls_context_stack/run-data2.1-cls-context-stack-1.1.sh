...
output_dir=exp-multiwoz/data2.1-cls-context-stack/v1.0-pretrain
target_slot='all'
nbt='context_stacked'
...
--train_batch_size 4 --eval_batch_size 4 --distance_metric product --patience 10 \
...
# NAN during pre-training

output_dir2=exp-multiwoz/data2.1-cls-context-stack/v1.0-tune
