...
# version 2.0 focus on improving classification performance
output_dir=exp-multiwoz/data2.1-cls-cache-type-prop/v2.0  # --sa_add_layer_norm
target_slot='all'
