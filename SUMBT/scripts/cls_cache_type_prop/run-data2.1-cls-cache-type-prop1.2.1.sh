...
output_dir=exp-multiwoz/data2.1-cls-cache-type-prop/v1.2  # distance_metric product -> cosine num_train_epochs 6 -> 5 learning_rate 5e-5 -> 1e-4
output_dir=exp-multiwoz/data2.1-cls-cache-type-prop/v1.2.1  # use hinge loss not cross entropy
target_slot='all'
