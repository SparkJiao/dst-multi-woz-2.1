...
#output_dir=exp-multiwoz/data2.1-share-cache-type/v1.2  # num_train_epochs = 5
output_dir=exp-multiwoz/data2.1-share-cache-type/v1.3  # num_train_epochs = 5 -> 24 batch_size 1 -> 4 gradient_accumulation_steps 1 -> 4
target_slot='all'
nbt='sa_cache_type'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 24 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 4 --eval_batch_size 2 --distance_metric product --patience 5 \
