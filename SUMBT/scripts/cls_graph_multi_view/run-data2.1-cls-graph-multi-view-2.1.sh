...
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v2.0  # version 2.0: max_seq_length 108 -> 80
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v2.1  # lr 4e-5 -> 5e-5
target_slot='all'
...
--tf_dir tensorboard --max_seq_length 80 --max_turn_length 22 \
