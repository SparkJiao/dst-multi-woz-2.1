...
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v1.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v1.2  # lr 3e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v3.0  # --fp16_opt_level O2 -> O1 --sa_add_layer_norm --graph_value_sup 0.9 -> 1.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v3.1  # lr 4e-5 -> 5e-5
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v3.2  # --multi_view_diag_attn_hidden_scale 1.0 -> 3.0
#output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v3.3  # lr 5e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v3.4  # lr 4e-5 -> 3e-5
target_slot='all'
nbt='graph_multi_view'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --multi_view_diag_attn_hidden_scale 3.0