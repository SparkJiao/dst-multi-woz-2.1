...
output_dir=exp-multiwoz/data2.1-cls-graph-multi-view/v1.3  # multi_view_diag_attn_hidden_scale 1.0 -> 2.0
target_slot='all'
...
--max_loss_scale 256 --value_embedding_type mean --multi_view_diag_attn_hidden_scale 2.0