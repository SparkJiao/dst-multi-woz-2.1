...
#output_dir=exp-multiwoz/data2.1-cls-flow/v1.0
#output_dir=exp-multiwoz/data2.1-cls-flow/v1.2  # num_train_epochs 6 -> 5
#output_dir=exp-multiwoz/data2.1-cls-flow/v1.3  # learning_rate 5e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-flow/v1.4  # flow_layer 6 -> 3
target_slot='all'
nbt='flow'
...
--cls_type 1 --flow_layer 3 --flow_head 4 --use_flow
