...
#output_dir=exp-multiwoz/data2.1-cls-flat-xl/v1.1  # --learning_rate 5e-5 -> 4e-5  num_train_epochs 6 -> 5
output_dir=exp-multiwoz/data2.1-cls-flat-xl/v1.2  # num_train_epochs 5 -> 6 --patience 10
target_slot='all'
nbt='flat_xl'
