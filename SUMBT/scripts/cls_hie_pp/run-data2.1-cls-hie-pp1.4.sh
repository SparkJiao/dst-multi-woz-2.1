...
#output_dir=exp-multiwoz/data2.1-cls-hie-pp/v1.3  # no pooling / epoch 8 -> 6
output_dir=exp-multiwoz/data2.1-cls-hie-pp/v1.4  # no multi-task
target_slot='all'
nbt='hie_pp'
...
--gate_type 0 --attn_head 6 --hie_add_sup 0.8 --use_flow \
