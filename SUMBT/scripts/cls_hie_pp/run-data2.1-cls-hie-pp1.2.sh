...
#output_dir=exp-multiwoz/data2.1-cls-hie-pp/v1.0
#output_dir=exp-multiwoz/data2.1-cls-hie-pp/v1.1  # --use_flow lr 4e-5 -> 5e-5 epoch 5 -> 6
output_dir=exp-multiwoz/data2.1-cls-hie-pp/v1.2  # share position embedding in flow & override attention from last layer of BERT
target_slot='all'
nbt='hie_pp'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls.py --do_train --do_eval --num_train_epochs 8 --data_dir data/multiwoz2.1_5 \
...
--use_pooling --pooling_head_num 1 --gate_type 0 --use_mt --attn_head 6 --hie_add_sup 0.8 --use_flow \
