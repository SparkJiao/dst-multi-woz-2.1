...
#output_dir=exp-multiwoz/data2.1-cls-graph-re/v1.0
output_dir=exp-multiwoz/data2.1-cls-graph-re/v1.2 # epoch 5 -> 8 -> 20 lr 4e-5 -> 1e-4
target_slot='all'
nbt='graph_re'
...
--cls_type 1 --graph_value_sup 0.5