...
output_dir=exp-multiwoz/data2.1-share-s-sa-flat/v1.0
target_slot='all'
nbt='flat_test1'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5s.py --do_train --do_eval --num_train_epochs 6 --data_dir data/multiwoz2.1_5 \
