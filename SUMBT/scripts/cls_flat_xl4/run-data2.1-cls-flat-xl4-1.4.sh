...
#output_dir=exp-multiwoz/data2.1-cls-flat-xl4/v1.1
#output_dir=exp-multiwoz/data2.1-cls-flat-xl4/v1.3 # --pre_turn 2 -> 3
output_dir=exp-multiwoz/data2.1-cls-flat-xl4/v1.4 # --pre_turn 3 -> 4
target_slot='all'
nbt='flat_xl4'
