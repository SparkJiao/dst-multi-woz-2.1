...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v3.7  # warmup proportion 0.1 -> 0.05
target_slot='all'
nbt='graph2_p'
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.05 --learning_rate 2e-5 \
