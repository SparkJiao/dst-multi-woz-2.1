...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.0-vsup=0.9-head=16
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --graph_attn_type 1 --graph_attn_head 16 --graph_add_layer_norm