...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-1.0  # head_num 12 -> 6
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-1.1  # lr 4e-5 -> 5e-5
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 1.0 --attn_head 6 --extra_nbt_attn_head 6 --diag_attn_hidden_scale 1.0 \
