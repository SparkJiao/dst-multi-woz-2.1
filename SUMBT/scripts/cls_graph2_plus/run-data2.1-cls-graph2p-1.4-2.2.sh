...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-2.2  # lr 3e-5 -> 1e-4 epoch 20 -> 7
target_slot='all'
nbt='graph2_p'
...
--train_batch_size 4 --eval_batch_size 1 --distance_metric product --patience 20 --per_eval_steps 1000 \
