...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-3.0  # max_seq_length 108 -> 80 lr 3e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-5.0  # max_seq_length 80 -> 64
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-5.3  # max_seq_length 64 -> 96
target_slot='all'
nbt='graph2_p'
