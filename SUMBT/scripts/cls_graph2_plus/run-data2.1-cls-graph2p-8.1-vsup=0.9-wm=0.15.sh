...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.1-vsup=0.9-wm=0.15  # lr 5e-5 -> 4e-5
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

# dev: 57.078 test: 51.831
...
--nbt $nbt --output_dir $output_dir --target_slot $target_slot --warmup_proportion 0.15 --learning_rate 4e-5 \
