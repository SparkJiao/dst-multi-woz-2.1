...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v6.0  # version 6.0 remove extra belief tracker  # the model file is deleted //
# 57.26 on dev // 52.86 on test
output_dir=exp-multiwoz/data2.1-cls-graph2p/v6.2  # lr 4e-5 -> 3e-5
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --graph_value_sup 1.0 --attn_head 12 --diag_attn_hidden_scale 1.0 \
