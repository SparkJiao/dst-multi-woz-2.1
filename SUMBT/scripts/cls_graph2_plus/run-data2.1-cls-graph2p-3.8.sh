...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v3.0  # version 3.0: --reverse
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v3.1  # lr 3e-5 -> 2e-5
output_dir=exp-multiwoz/data2.1-cls-graph2p/v3.8  # --diag_attn_hidden 1.0 -> 0.5
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.9 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 0.5 \
--max_loss_scale 256 --value_embedding_type mean --reverse