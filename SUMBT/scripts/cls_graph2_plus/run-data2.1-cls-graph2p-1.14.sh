...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.13  # fuse_type 0 -> 2
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.14  # lr 3e-5 -> 4e-5
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --fuse_type 2