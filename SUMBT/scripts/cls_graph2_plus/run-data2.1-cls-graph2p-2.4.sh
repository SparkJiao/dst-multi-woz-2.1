...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v2.0  # version 2.0 add graph supervision
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v2.1  # lr 3e-5 -> 2.5e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v2.2  # lr 2.5e-5 -> 2e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v2.3  # --graph_add_sup 0.2 -> 0.6
output_dir=exp-multiwoz/data2.1-cls-graph2p/v2.4  # --graph_add_sup 0.2 -> 0.8
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --graph_add_sup 0.8