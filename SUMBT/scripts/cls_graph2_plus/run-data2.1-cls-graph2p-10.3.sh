...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v10.0  # add --mask_self
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v10.1  # lr 5e-5 -> 4e-5
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v10.2  # --graph_add_layer_norm
output_dir=exp-multiwoz/data2.1-cls-graph2p/v10.3  # --graph_add_output
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

# dev: 56.5636  test: 52.129
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --graph_attn_type 1 --graph_attn_head 12 --mask_self \
--graph_add_layer_norm  --graph_add_output