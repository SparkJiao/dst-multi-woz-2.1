...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-taxi-single-1.1
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls.py --do_train --do_eval --num_train_epochs 2 --data_dir data/multiwoz2.1_5 \
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm  --train_single taxi
