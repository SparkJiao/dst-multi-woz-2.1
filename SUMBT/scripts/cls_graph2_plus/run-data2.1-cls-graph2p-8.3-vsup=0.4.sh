...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.3-vsup=0.4  # --sa_add_residual
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.4 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
