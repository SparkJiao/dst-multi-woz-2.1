...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.8  # --diag_attn_act relu --fusion_no_transform
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.9  # --fusion_act_fn relu
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --diag_attn_act relu  --fusion_no_transform --fusion_act_fn relu