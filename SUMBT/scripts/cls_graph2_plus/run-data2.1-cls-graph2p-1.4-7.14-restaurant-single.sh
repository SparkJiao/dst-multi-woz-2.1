...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-restaurant-single
target_slot='all'
train_single='restaurant'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --train_single ${train_single}
