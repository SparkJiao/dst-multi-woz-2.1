...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-vsup=1.3   # --graph_value_sup 0.9 -> 1.0
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 1.3 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
