...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.6  # significance test => fuse function
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.7  # lr 3e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.10  # --diag_attn_act relu
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --fuse_type 1 --diag_attn_act relu