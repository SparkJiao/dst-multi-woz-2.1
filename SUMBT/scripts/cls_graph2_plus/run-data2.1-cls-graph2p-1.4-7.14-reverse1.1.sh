...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-reverse   # --graph_value_sup 0.9 -> 1.0
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-reverse1.1  # lr 4e-5 -> 5e-5
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --reverse