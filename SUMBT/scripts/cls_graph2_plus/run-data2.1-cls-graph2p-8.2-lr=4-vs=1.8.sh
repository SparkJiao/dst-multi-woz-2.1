...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.2-lr=4-vs=1.8 #--graph_add_output
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

# dev: 58.014  test: 53.513
...
--cls_type 0 --extra_nbt --graph_value_sup 1.8 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --graph_attn_type 1 --graph_attn_head 12 \
