...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-2.0  # version 1.4-2.0 use larger batch size
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-2.1  # lr 3e-5 -> 4e-5
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5-newcls.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 4 --eval_batch_size 2 --distance_metric product --patience 20 \
