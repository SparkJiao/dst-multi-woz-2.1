...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v5.0  # version 5.0 add slot restriction
output_dir=exp-multiwoz/data2.1-cls-graph2p/v5.1  # slot_res train -> taxi
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

slot_res='20:21:22:23'  # taxi
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --save_gate --slot_res ${slot_res}