...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.7  # --fuse_type 4
target_slot='all'
nbt='graph2_p'
...
--fuse_type 4 --cls_type 0 --extra_nbt --graph_value_sup 0.9 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
