...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.22  # --key_add_value
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.24  # --key_add_value_pro
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.25  # lr 4e-5 -> 5e-5
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --save_gate --key_add_value --key_add_value_pro