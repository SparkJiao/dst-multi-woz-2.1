...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.12  # --diag_attn_act gelu
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --diag_attn_act gelu  --fusion_no_transform