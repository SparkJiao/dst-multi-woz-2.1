...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-4.0  # --attn_head 4 --extra_nbt_attn_head 4
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-4.2  # lr 3e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-4.4  # lr 4e-5 -> 5e-5
target_slot='all'
nbt='graph2_p'
