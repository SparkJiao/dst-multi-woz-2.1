...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.8-seed23  # --sa_add_layer_norm
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.13  # --diag_attn_hidden_scale 1.0 -> 1.5
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.9 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.5 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm  --seed 23