...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v7.2  # lr 4e-5 -> 3e-5
output_dir=exp-multiwoz/data2.1-cls-graph2p/v7.2-wm=0.2  # warmup_proportion 0.1 -> 0.2
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --graph_attn_type 1 --graph_attn_head 6