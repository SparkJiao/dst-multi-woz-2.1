...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-1.5  # attn_head 12 -> 4 / extra_nbt_head 12 -> 4
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-1.6  # lr 3e-5 -> 2e-5 epoch 5 -> 6
target_slot='all'
nbt='graph2_p'
