...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v9.0  # remove --extra_nbt
output_dir=exp-multiwoz/data2.1-cls-graph2p/v9.1  # lr 5e-5 -> 4e-5
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

# dev: 56.2517 test: 53.174 没改参数！
...
--cls_type 0 --graph_value_sup 1.0 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
