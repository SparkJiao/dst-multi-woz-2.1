...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.2-lr=4 #--graph_add_output
output_dir=exp-multiwoz/data2.1-cls-graph2p/v8.3-vsup=0.7  # --sa_add_residual
target_slot='all'
nbt='graph2_p'
bert_dir='/home/jiaofangkai/'

# dev: 56.387  test: 53.703
...
--cls_type 0 --extra_nbt --graph_value_sup 0.7 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --sa_add_residual --graph_attn_type 1 --graph_attn_head 12 \
--graph_add_output --graph_add_layer_norm