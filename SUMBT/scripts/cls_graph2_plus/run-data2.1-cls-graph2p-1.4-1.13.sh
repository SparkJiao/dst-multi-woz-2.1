...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-1.7  # --diag_attn_act_fn gelu
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-1.8  # lr 3e-5 -> 4e-5
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-1.13  # diag_attn_hidden_scale 1.0 -> 2.0
target_slot='all'
nbt='graph2_p'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.9 --attn_head 12 --extra_nbt_attn_head 12 --diag_attn_hidden_scale 2.0 \
--max_loss_scale 256 --value_embedding_type mean --diag_attn_act_fn gelu