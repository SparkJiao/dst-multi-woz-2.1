...
#output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.5  # --attn_head 12 -> 4 --extra_nbt_head 12 -> 4
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.7  # --dropout 0.2
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --dropout 0.2