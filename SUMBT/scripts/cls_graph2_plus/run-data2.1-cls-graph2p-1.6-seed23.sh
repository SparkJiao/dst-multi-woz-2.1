...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.6-seed23  # significance test => fuse function
target_slot='all'
nbt='graph2_p'
...
--max_loss_scale 256 --value_embedding_type mean --fuse_type 1 --seed 23