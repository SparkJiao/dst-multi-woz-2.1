...
#output_dir=exp-multiwoz/data2.1-cls-graph2ppp/v1.0
#output_dir=exp-multiwoz/data2.1-cls-graph2ppp/v1.1  # head num 12 -> 4
output_dir=exp-multiwoz/data2.1-cls-graph2ppp/v1.4  # epoch 5 -> 6
target_slot='all'
nbt='graph2_ppp'
...
--cls_type 0 --extra_nbt --graph_value_sup 0.9 --attn_head 4 --extra_nbt_attn_head 4 --diag_attn_hidden_scale 1.0 \
--max_loss_scale 256 --value_embedding_type mean --fuse_type 0 --sa_fuse_act_fn gelu