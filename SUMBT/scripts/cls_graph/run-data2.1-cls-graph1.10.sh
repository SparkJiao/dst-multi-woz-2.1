...
#output_dir=exp-multiwoz/data2.1-cls-graph/v1.2
#output_dir=exp-multiwoz/data2.1-cls-graph/v1.8  # No supervision
output_dir=exp-multiwoz/data2.1-cls-graph/v1.10  # only value supervision
target_slot='all'
nbt='graph'
...
--cls_type 1 --extra_nbt --graph_value_sup 0.8