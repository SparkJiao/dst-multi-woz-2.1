...
#output_dir=exp-multiwoz/data2.1-cls-graph/v1.0
output_dir=exp-multiwoz/data2.1-cls-graph/v1.6  # lr 5e-5 -> 3e-5 epoch 6 -> 5
target_slot='all'
nbt='graph'
...
--cls_type 1 --graph_add_sup 0.2 --graph_value_sup 0.8