...
# no --override_attn / no extra supervision during fine-tune

output_dir=exp-multiwoz/data2.1-cls-graph/v1.5-s0
target_slot='all'
nbt='graph'
...
--train_batch_size 4 --eval_batch_size 4 --distance_metric product --patience 5 \
...
--cls_type 1 --graph_add_sup 0.5 --graph_value_sup 0.8 --extra_nbt \
--fix_bert

output_dir2=exp-multiwoz/data2.1-cls-graph/v1.5-s1
