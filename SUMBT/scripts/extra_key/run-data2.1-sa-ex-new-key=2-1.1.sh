...
output_dir=exp-multiwoz/data2.1-share-sa-ex/key=2-v1.1
target_slot='all'
nbt='extend_new'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 10 --data_dir data/multiwoz2.1_5 \
...
--override_attn --share_position_weight --self_attention_type 1 --key_type 2 \
\
