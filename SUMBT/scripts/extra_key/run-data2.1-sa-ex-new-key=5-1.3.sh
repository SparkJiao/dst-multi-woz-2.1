...
#output_dir=exp-multiwoz/data2.1-share-sa-ex/key=5-v1.0
#output_dir=exp-multiwoz/data2.1-share-sa-ex/key=5-v1.1  # share_type copy_weight -> full_share
#output_dir=exp-multiwoz/data2.1-share-sa-ex/key=5-v1.2  # share_type full_share -> share_weight
output_dir=exp-multiwoz/data2.1-share-sa-ex/key=5-v1.2  # share_type full_share -> share_weight
target_slot='all'
nbt='extend_new'
...
--override_attn --share_position_weight --self_attention_type 1 --key_type 5 \
--share_type from_scratch \
