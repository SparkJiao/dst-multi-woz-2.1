...
output_dir=exp-multiwoz/data2.0-share-sa-flat-slot1.1
target_slot='all'
nbt='flat_slot'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share.py --do_train --do_eval --num_train_epochs 7 --data_dir data/multiwoz2.0 \
...
--tf_dir tensorboard --max_seq_length 72 --max_turn_length 22 \
--fp16 --fp16_opt_level O2 --gradient_accumulation_steps 1 \
--reduce_layers 0 --max_label_length 17 --max_slot_length 6 \
--override_attn --share_position_weight --share_type copy_weight
