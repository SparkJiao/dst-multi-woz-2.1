...
output_dir=exp-multiwoz/exp-data2.1-5r-share1.0
target_slot='all'
bert_dir='/home/jiaofangkai/'

python3 code/main-multislot-share-5r.py --do_train --do_eval --num_train_epochs 20 --data_dir data/multiwoz2.1_5 \
