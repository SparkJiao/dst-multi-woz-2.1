...
output_dir=exp-multiwoz/exp-data2.1-5full-share-tf1.4-s0
target_slot='all'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 50 --data_dir data/multiwoz2.1_5 \
...
--train_batch_size 32 --eval_batch_size 1 --distance_metric product --patience 10 \
--tf_dir tensorboard --max_seq_length 96 --max_turn_length 22 \
--fp16 --fp16_opt_level O2 --gradient_accumulation_steps 8 \
--reduce_layers 6 --num_rnn_layers 6 --max_label_length 20 --max_slot_length 6 \
...
output_dir=exp-multiwoz/exp-data2.1-5full-share-tf1.4-s1
...
--test_file data/multiwoz2.1_5/test-5-full-value.tsv \
--ontology data/multiwoz2.1_5/ontology-full.json \
--pretrain exp-multiwoz/exp-data2.1-5full-share-tf1.4-s0/pytorch_model.bin
