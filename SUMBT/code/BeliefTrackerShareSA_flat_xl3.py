...
try:
    from . import layers
    from .modeling_bert_xl3 import BertModel, SimpleDialogSelfAttention, SimpleSelfAttention
...
class BeliefTracker(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, answer_type_ids, labels, n_gpu=1, target_slot=None):
        ...
        hidden = self.hidden_output(hidden)  # Since version >= 3, add hidden output: BiLinear similarity
