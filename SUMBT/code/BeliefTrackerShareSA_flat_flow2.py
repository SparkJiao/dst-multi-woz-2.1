...
try:
    from . import layers
    from .modeling_bert_ex_flow2 import BertModel, SimpleDialogSelfAttention, SimpleSelfAttention
...
class BeliefTracker(nn.Module):
    def __init__(self, args, num_labels, device):
        ...
        # logger.info(f"Flow attention share type: {args.share_type}")
        # for layer in self.utterance_encoder.bert.encoder.layer:
        #     getattr(layer, args.share_type)()
