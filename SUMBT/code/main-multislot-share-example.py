...
def select_value_examples(labels, example_num, slots, data_len, max_seq_length, tokenizer: BertTokenizer, fix: bool = False):
    """ How to select examples from unseen domain? """
