...
#output_dir=exp-multiwoz/data2.0-share-sa-slot1.0  # --share_position_weight
output_dir=exp-multiwoz/data2.0-share-sa-slot1.1  # full_share -> copy_weight
target_slot='all'
nbt='slot'
...
--override_attn --share_position_weight --slot_attention_type 1
