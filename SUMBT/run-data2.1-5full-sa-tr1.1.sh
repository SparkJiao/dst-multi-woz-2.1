...
output_dir=exp-multiwoz/data2.1-5full-sa-tr1.1
target_slot='all'
nbt='transpose'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-5.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.1_5 \
...
--override_attn --transpose_layer 3
