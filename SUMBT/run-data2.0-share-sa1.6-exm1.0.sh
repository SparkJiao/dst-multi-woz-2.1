...
output_dir=exp-multiwoz/data2.0-share-sa1.6-exm1.0  # --share_position_weight
target_slot='all'
nbt='sa'
bert_dir='/home/jiaofangkai/'

python code/main-multislot-share-example.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.0 \
...
--reduce_layers 0 --max_label_length 17 --max_slot_length 20 --example_num 3 \
