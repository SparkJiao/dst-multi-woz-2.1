...
from transformers.models.bert.modeling_bert import BertPooler, BertPreTrainedModel, BertIntermediate, BertOutput, BertSelfOutput, BertConfig
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config: BertConfig):
        ...
        self.LayerNorm = LayerNorm(config.hidden_size, eps=1e-6)
    ...
    def __init__(self, config: BertConfig, add_output: bool = True, add_layer_norm: bool = False, add_residual: bool = False,
        ...
        if add_output:
            ...
            if self.add_layer_norm:
                ...
                self.saLayerNorm = nn.LayerNorm(config.hidden_size, eps=1e-6)
