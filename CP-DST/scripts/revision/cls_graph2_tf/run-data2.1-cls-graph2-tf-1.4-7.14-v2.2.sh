...
for seed in 46; do
  ...
  output_dir=exp-multiwoz/data2.1-cls-graph2-tf/v1.4-7.14.seq108.v2.2.1r${lr}.A100.s${seed}

  CUDA_VISIBLE_DEVICES=${gpu} python code/main-multislot-share-5-newcls.py --do_train --do_eval --num_train_epochs 5 --data_dir data/multiwoz2.1_5 \
  ...
  --max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --seed ${seed}
done