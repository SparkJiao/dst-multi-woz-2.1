...
output_dir=exp-multiwoz/data2.1-cls-graph2-tf/v1.4-7.14.seq64.v1.1.A100
target_slot='all'
nbt='graph2p_tf'
bert_dir='./pretrained-models/'

python code/main-multislot-share-5-newcls.py --do_eval --num_train_epochs 10 --data_dir data/multiwoz2.1_5 \
