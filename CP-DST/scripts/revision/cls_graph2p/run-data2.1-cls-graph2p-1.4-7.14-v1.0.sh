...
output_dir=exp-multiwoz/data2.1-cls-graph2p/v1.4-7.14-v1.0
target_slot='all'
nbt='graph2_p'
bert_dir='./pretrained-models/'

python code/main-multislot-share-5-newcls.py --do_train --do_eval --num_train_epochs 30 --data_dir data/multiwoz2.1_5 \
...
--fp16 --fp16_opt_level O1 --gradient_accumulation_steps 4 \
