...
target_slot='all'
nbt='graph2p_fuse_baseline'
bert_dir='./pretrained-models/'

#for seed in 42 43; do
for seed in 42 43 44 45 46; do
#for seed in 46; do
  output_dir=exp-multiwoz/data2.1-cls-graph2p-lin-fuse/v1.4-7.14.2080Ti.s${seed}
  ...
  --max_loss_scale 256 --value_embedding_type mean --sa_add_layer_norm --fuse_type 0 \
  --seed ${seed}
done